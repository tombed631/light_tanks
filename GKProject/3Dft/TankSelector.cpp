...
namespace p3d {
	...
	PlTankTypes TankSelector::run() {
		...
		modelShader = Shader("../GKProject/Shaders/vertexShader.glsl", "../GKProject/Shaders/fragmentShader.glsl");
		lightShader = Shader("../GKProject/Shaders/lightSrcVerxShd.glsl", "../GKProject/Shaders/lightSrcFragShd.glsl");
		model3d = ModelLoader::loadFromFile("../GKProject/Models/abrams/Abrams_BF3.obj");
